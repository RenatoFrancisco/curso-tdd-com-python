...
def test_deve_permitir_propor_lance_quando_o_valor_eh_menor_que_valor_da_carteira():
    vini = Usuario('Vini', 100.0)
...
def test_nao_deve_permitir_propor_lance_quando_o_valor_eh_maior_que_valor_da_carteira():
    vini = Usuario('Vini', 100.0)
